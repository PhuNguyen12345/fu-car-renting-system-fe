        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-xl overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea 
                    ...
                    disabled={!['INITIATED', 'CONFIRMED'].includes(viewBooking.bookingStatus)}
                    placeholder={['INITIATED', 'CONFIRMED'].includes(viewBooking.bookingStatus) ? "Nhập lý do nếu muốn từ chối đơn này..." : "Không có ghi chú"}
            ...
            <div className="px-6 py-4 border-t border-slate-100 flex justify-end gap-3 bg-slate-50 shrink-0">
              ...
              {['INITIATED', 'CONFIRMED'].includes(viewBooking.bookingStatus) && (
                <>
                  <button 
                    onClick={() => {
